                ...
                return (
                    ...
                    >
                        ...
                        <p>
                            ...
                            Gateway') is a cryptocurrency gateway to ZCOME which
                            ...
                            ZCOME. For the convenience of wording in this
                        ...
                        <p>
                            5. You understand that ZCOME is a decentralized
                            exchange based on blockchain, the basic account
                            service and the trade processing service are
                            provided by ZCOME, there are also other institutions
                            or single persons that issue assets and/or provide
                            service on ZCOME. You understand that the Gateway is
                            only used for you to deposit/withdraw cryptocurrency
                            to/from ZCOME. The Gateway only undertake the due
                            ...
                            ZCOME, do not undertake the due obligations for
                            availability of the assets issued by other
                            institutions or single persons.{" "}
                        </p>
                        <p>
                            6. There are risk in both Internet and ZCOME,
                            include but not limit to failure for software,
                            hardware to connect to Internet, security risk for
                            ZCOME accounting system. As the availability and
                            reliability of Internet and ZCOME are not under our
