...
Bug fixes
--------
- Add ZCOME bloom filter for BTS 1 account imports
...
- Update the Blocktrades bridge code to use the correct wallet symbols for MKR on the ZCOME blockchain
