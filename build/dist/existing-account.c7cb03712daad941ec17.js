                    ...
                    T(t, [
                        {
                            ...
                            value: function() {
                                var e = p.a.getState().keys.keySeq();
                        ...
                        },
                        {
                            key: "componentWillReceiveProps",
                            value: function(e) {
                                var t = p.a.getState().keys.keySeq();
                                ...
                                value: function(e) {
                                    ...
                                    try {
                                        for (
                                            ...
                                            var p = c.value;
                                            if (p.encrypted_private_keys)
                                                for (
                                                    var m = p.account_name.trim(),
                                                        y = new RegExp(
                                                            "^" +
                                                                u.ChainConfig
                                                                    .address_prefix
                                    ...
                                    try {
                                        for (
                                            ...
                                            var s = i.value,
                                                u = t[s],
                                                f = u.account_names,
                                                p = u.public_key_string;
                                            n.push({
                                                private_plainhex: s,
                                                import_account_names: f,
                                                public_key_string: p
                                            });
                                        }
                                    } catch (e) {
